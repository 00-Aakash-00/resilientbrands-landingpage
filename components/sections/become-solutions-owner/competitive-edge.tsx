            ...
            <div className="relative bg-slate-900/90 backdrop-blur-sm rounded-3xl p-10 border border-amber-500/30">
              ...
              >
                ...
                <div>
                  ...
                  >
                    They are the frontline advisors shaping technology decisions
                    for businesses worldwide. By giving them ownership, we
                    unlock easier adoption, lower issues, and a growth flywheel
                    built on expertise.
                  </p>
                </div>
              </motion.div>
                    ...
                    <p
                      className={`${
                        isSmallMobile
                          ...
                          ? "text-lg"
                          : "text-xl"
                      } text-neutral-300 mb-4 leading-relaxed`}
                    >
                      You&apos;ve waited long enough to stop selling other
                      people&apos;s futures. With Resilient Brands, you finally
                      get to own the upside you create.
                    </p>
                    <p
                      className={`${
                        isSmallMobile
                          ...
                          ? "text-xl"
                          : "text-2xl"
                      } text-transparent bg-gradient-to-r from-amber-400 to-yellow-400 bg-clip-text font-semibold`}
                    >
                    ...
                    <p
                      className={`${
                        isSmallMobile
                          ...
                          ? "text-lg"
                          : "text-xl"
                      } text-neutral-200 mt-2`}
                    >
                      You&apos;re not just funding products. You&apos;re fueling
                      a movement of providers becoming owners.
                    </p>
                  </div>
                </div>
              </motion.div>
