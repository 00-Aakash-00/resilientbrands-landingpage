...
const bentoItems = [
  {
    ...
    subtitle: "Simplify. Standardize. Improve. Scale.",
    description: "Consolidation and maturity progression — minus the sprawl.",
    icon: Shield,
    color: "#00D9FF",
    accentColor: "#0095FF",
    size: "large",
  ...
  },
  {
    ...
    description: "Policies aligned, proof collected, and confidence built into every step.",
    icon: FileCheck,
    color: "#00FF88",
    accentColor: "#00CC6A",
    size: "medium",
  ...
  {
    id: 4,
    title: "Privacy. Powered by Control.",
    subtitle: "",
    description: "From data rights to regulatory risks — your brand identity, secured and simplified.",
    icon: Lock,
    color: "#BB00FF",
    accentColor: "#9000FF",
    size: "small",
  ...
  {
    id: 5,
    title: "Analytics Engine. Opportunity, Unlocked.",
    subtitle: "",
    description: "Pinpoint the right solutions, match the right services, and track maturity in real time.",
    icon: BarChart3,
    color: "#FFB800",
    accentColor: "#FF9500",
    size: "wide",
  ...
  {
    id: 6,
    title: "Tech Debt. Turned Into Leverage.",
    subtitle: "",
    description: "Stop sinking 40% of your IT budget into debt — start investing it into leadership.",
    icon: Gauge,
    color: "#FF3366",
    accentColor: "#FF0044",
    size: "small",
