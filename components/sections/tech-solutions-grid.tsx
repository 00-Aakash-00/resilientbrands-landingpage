...
import { Shield, FileCheck, Cloud, Lock, TrendingUp, Zap, Building2, BarChart3, Gauge } from "lucide-react"
    ...
    svg: (
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 600 500" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          ...
          <pattern id="sec-grid" x="0" y="0" width="50" height="50" patternUnits="userSpaceOnUse">
            <path d="M0 25 L50 25 M25 0 L25 50" stroke="#00D9FF" strokeWidth="0.25" opacity="0.15" />
        ...
        <g transform="translate(300, 250)" opacity="0.5">
          ...
          <g transform="scale(1.5)">
            <path d="M0 -40 L0 40 Q0 50 -10 45 L-35 25 Q-45 20 -45 10 L-45 -20 Q-45 -30 -35 -35 L-10 -50 Q0 -55 0 -45 Q0 -55 10 -50 L35 -35 Q45 -30 45 -20 L45 10 Q45 20 35 25 L10 45 Q0 50 0 40 Z" 
                  fill="url(#sec-grad)" />
            <path d="M0 -40 L0 40 Q0 50 -10 45 L-35 25 Q-45 20 -45 10 L-45 -20 Q-45 -30 -35 -35 L-10 -50 Q0 -55 0 -45 Q0 -55 10 -50 L35 -35 Q45 -30 45 -20 L45 10 Q45 20 35 25 L10 45 Q0 50 0 40 Z" 
          ...
          {[0, 60, 120, 180, 240, 300].map((angle, i) => (
            <g key={i} transform={`rotate(${angle})`}>
              ...
              <line x1="50" y1="0" x2="145" y2="0" stroke="#00D9FF" strokeWidth="0.5" opacity="0.3" strokeDasharray="2 4">
          ...
          <g opacity="0.6">
            <path d="M-150 -100 Q-75 -50 0 0 Q75 50 150 100" stroke="#00D9FF" strokeWidth="1" fill="none" strokeDasharray="5 10">
              <animate attributeName="stroke-dashoffset" from="0" to="-15" dur="2s" repeatCount="indefinite" />
            </path>
            <path d="M150 -100 Q75 -50 0 0 Q-75 50 -150 100" stroke="#0095FF" strokeWidth="1" fill="none" strokeDasharray="5 10">
              <animate attributeName="stroke-dashoffset" from="0" to="-15" dur="2s" begin="1s" repeatCount="indefinite" />
            </path>
          </g>
        </g>
  ...
  },
  {
    ...
    svg: (
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 500" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g opacity="0.15">
          {[...Array(10)].map((_, i) => (
            <line key={i} x1="0" y1={i * 50} x2="400" y2={i * 50} stroke="#00FF88" strokeWidth="0.5" />
          ))}
          {[...Array(8)].map((_, i) => (
            <line key={i} x1={i * 50} y1="0" x2={i * 50} y2="500" stroke="#00FF88" strokeWidth="0.5" />
          ))}
        </g>
        ...
        <g transform="translate(200, 200)" opacity="0.5">
          ...
          {/* Main document */}
          <rect x="-70" y="-90" width="140" height="180" rx="4" fill="none" stroke="#00FF88" strokeWidth="2" />
          <rect x="-65" y="-85" width="130" height="30" fill="url(#comp-grad)" />
          
          {/* Check items with animation */}
          {[0, 1, 2, 3, 4].map((i) => (
            <g key={i} transform={`translate(-50, ${-50 + i * 30})`}>
              <rect x="0" y="0" width="12" height="12" rx="2" fill="none" stroke="#00FF88" strokeWidth="1.5" />
              <path d="M2 6 L5 9 L10 3" stroke="#00FF88" strokeWidth="2" fill="none" strokeLinecap="round">
                <animate attributeName="stroke-dasharray" from="0 20" to="20 0" dur="0.5s" begin={`${i * 0.2}s`} fill="freeze" />
              </path>
              <rect x="20" y="4" width={60 + i * 5} height="4" fill="#00FF88" opacity="0.3" />
            </g>
          ))}
        </g>
        ...
        <g opacity="0.6">
          <g transform="translate(100, 400)">
            ...
            <path d="M-10 0 L-5 5 L10 -10" stroke="#00FF88" strokeWidth="2" strokeLinecap="round" />
          </g>
          <g transform="translate(300, 400)">
            <circle cx="0" cy="0" r="25" fill="url(#comp-grad)" />
            <text x="0" y="5" fill="#00FF88" fontSize="12" fontWeight="bold" textAnchor="middle">ISO</text>
          </g>
        </g>
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 500" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Network grid */}
        <g opacity="0.1">
          <pattern id="cloud-net" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
            <circle cx="50" cy="50" r="30" fill="none" stroke="#00B4FF" strokeWidth="0.5" />
        ...
        <g transform="translate(200, 350)" opacity="0.5">
          {/* Central server */}
          <rect x="-40" y="-40" width="80" height="80" rx="4" fill="none" stroke="#00B4FF" strokeWidth="2" />
          {[0, 1, 2, 3].map((i) => (
            <rect key={i} x="-35" y={-35 + i * 18} width="70" height="15" fill="#00B4FF" opacity={i % 2 === 0 ? 0.3 : 0.2} />
          ))}
          ...
          {[
            ...
            <g key={i} transform={`translate(${pos.x}, ${pos.y})`}>
              <rect x="-20" y="-20" width="40" height="40" rx="4" fill="none" stroke="#00B4FF" strokeWidth="1" opacity="0.6" />
              <rect x="-15" y="-15" width="30" height="8" fill="#00B4FF" opacity="0.3" />
              <line x1={-pos.x / 3} y1={-pos.y / 3} x2={-pos.x * 0.6} y2={-pos.y * 0.6} stroke="#00B4FF" strokeWidth="1" opacity="0.4" strokeDasharray="2 4">
                <animate attributeName="stroke-dashoffset" from="0" to="-6" dur="1s" repeatCount="indefinite" />
              </line>
            </g>
          ))}
  ...
  },
  {
    ...
    svg: (
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Background circuit */}
        <g opacity="0.15">
          <path d="M50 50 L100 50 L100 100 M200 50 L250 50 L250 100 L200 100 L200 150 L250 150" stroke="#BB00FF" strokeWidth="0.5" />
          <path d="M50 250 L100 250 L100 200 M200 250 L250 250 L250 200 L200 200 L200 150" stroke="#BB00FF" strokeWidth="0.5" />
        ...
        <g transform="translate(150, 150)" opacity="0.5">
          {/* Shield background */}
          <path d="M0 -50 L0 50 Q0 65 -15 58 L-45 35 Q-60 28 -60 13 L-60 -25 Q-60 -40 -45 -47 L-15 -65 Q0 -72 0 -57 Q0 -72 15 -65 L45 -47 Q60 -40 60 -25 L60 13 Q60 28 45 35 L15 58 Q0 65 0 50 Z" 
                fill="url(#priv-grad)" />
          
          {/* Lock body */}
          <rect x="-25" y="-10" width="50" height="35" rx="5" fill="#BB00FF" opacity="0.3" />
          <rect x="-25" y="-10" width="50" height="35" rx="5" fill="none" stroke="#BB00FF" strokeWidth="2" />
          
          {/* Lock shackle */}
          <path d="M-15 -10 L-15 -25 Q-15 -35 0 -35 Q15 -35 15 -25 L15 -10" 
                stroke="#BB00FF" strokeWidth="3" fill="none" strokeLinecap="round" />
          ...
          {/* Protection rings */}
          <circle cx="0" cy="0" r="70" fill="none" stroke="#BB00FF" strokeWidth="0.5" opacity="0.3" strokeDasharray="5 10" />
          <circle cx="0" cy="0" r="85" fill="none" stroke="#BB00FF" strokeWidth="0.5" opacity="0.2" strokeDasharray="10 5" />
        </g>
      </svg>
    )
  },
    ...
    svg: (
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 600 300" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g opacity="0.1">
          {[...Array(6)].map((_, i) => (
            <g key={i}>
              <line x1="50" y1={50 + i * 40} x2="550" y2={50 + i * 40} stroke="#FFB800" strokeWidth="0.5" />
              <text x="40" y={55 + i * 40} fill="#FFB800" fontSize="8" textAnchor="end">{100 - i * 20}</text>
            </g>
          ))}
          {[...Array(6)].map((_, i) => (
            <g key={i}>
              <line x1={100 + i * 90} y1="50" x2={100 + i * 90} y2="250" stroke="#FFB800" strokeWidth="0.5" />
              <text x={100 + i * 90} y="265" fill="#FFB800" fontSize="8" textAnchor="middle">M{i + 1}</text>
            </g>
          ))}
        </g>
        ...
        <g opacity="0.5">
          {[
            ...
            <rect 
              ...
              fill="url(#chart-grad)"
            >
              <animate attributeName="height" from="0" to={bar.h} dur="0.5s" begin={`${i * 0.1}s`} fill="freeze" />
              <animate attributeName="y" from="250" to={250 - bar.h} dur="0.5s" begin={`${i * 0.1}s`} fill="freeze" />
            </rect>
          ))}
        </g>
        
        {/* Trend line */}
        <path d="M100 200 L190 170 L280 140 L370 120 L460 90 L550 60" 
              stroke="url(#line-grad)" strokeWidth="3" fill="none" opacity="0.7">
          ...
          {[
            ...
            <g key={i}>
              <circle cx={point.x} cy={point.y} r="6" fill="#FFB800">
                <animate attributeName="r" from="0" to="6" dur="0.3s" begin={`${0.5 + i * 0.2}s`} fill="freeze" />
              </circle>
        ...
        {/* Axes */}
        <line x1="50" y1="250" x2="550" y2="250" stroke="#FFB800" strokeWidth="2" opacity="0.5" />
        <line x1="50" y1="50" x2="50" y2="250" stroke="#FFB800" strokeWidth="2" opacity="0.5" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Background elements */}
        <g opacity="0.1">
          <circle cx="150" cy="150" r="120" fill="none" stroke="#FF3366" strokeWidth="0.5" />
          <circle cx="150" cy="150" r="100" fill="none" stroke="#FF3366" strokeWidth="0.5" />
          <circle cx="150" cy="150" r="80" fill="none" stroke="#FF3366" strokeWidth="0.5" />
        </g>
        
        {/* Gauge */}
        <g transform="translate(150, 150)" opacity="0.5">
          {/* Gauge arc segments */}
          <path d="M -70 40 A 80 80 0 0 1 -56 -56" fill="none" stroke="#00FF88" strokeWidth="12" opacity="0.5" strokeLinecap="round" />
          <path d="M -56 -56 A 80 80 0 0 1 0 -80" fill="none" stroke="#FFB800" strokeWidth="12" opacity="0.5" strokeLinecap="round" />
          <path d="M 0 -80 A 80 80 0 0 1 56 -56" fill="none" stroke="#FF9500" strokeWidth="12" opacity="0.5" strokeLinecap="round" />
          <path d="M 56 -56 A 80 80 0 0 1 70 40" fill="none" stroke="#FF3366" strokeWidth="12" opacity="0.7" strokeLinecap="round" />
          
          {/* Scale marks */}
          {[-135, -90, -45, 0, 45].map((angle, i) => (
            <g key={i} transform={`rotate(${angle})`}>
              <line x1="0" y1="-95" x2="0" y2="-85" stroke="#FF3366" strokeWidth="2" opacity="0.8" />
              <line x1="0" y1="-75" x2="0" y2="-70" stroke="#FF3366" strokeWidth="1" opacity="0.5" />
            </g>
          ))}
          
          {/* Needle */}
          <g>
            <animateTransform attributeName="transform" type="rotate" values="-135;-45;-135" dur="4s" repeatCount="indefinite" />
            <line x1="0" y1="0" x2="0" y2="-70" stroke="#FF3366" strokeWidth="3" strokeLinecap="round" />
            <circle cx="0" cy="0" r="10" fill="url(#gauge-grad)" />
            <circle cx="0" cy="0" r="6" fill="#FF3366" />
          </g>
          
          {/* Digital display */}
          <rect x="-30" y="40" width="60" height="25" rx="5" fill="#FF3366" opacity="0.2" />
          <text x="0" y="56" fill="#FF3366" fontSize="14" fontWeight="bold" textAnchor="middle">15%</text>
        </g>
      </svg>
    )
  }
        ...
        {bentoItems.map((item, index) => {
          ...
          return (
            <motion.div
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(15, 23, 42, 0.97), rgba(2, 6, 23, 0.95))',
              ...
              <div className="relative h-full p-6 flex flex-col">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-start gap-3">
                    <div className="p-2 rounded-md bg-gradient-to-br" style={{ 
                    ...
                    <div className="flex-1">
                      <h3 className="text-base font-semibold text-white tracking-tight leading-tight mb-1">{item.title}</h3>
                      <p className="text-xs font-medium text-slate-500 uppercase tracking-wider" style={{ letterSpacing: '0.05em' }}>{item.subtitle}</p>
                    </div>
                  </div>
                </div>
                
                <p className="text-xs leading-relaxed text-slate-400 mb-auto font-normal" style={{ lineHeight: '1.6' }}>
                  {item.description}
                </p>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {Object.entries(item.stats).map(([key, value]) => (
                        <div key={key} className="text-center">
                          <div className="text-lg font-bold tracking-tight mb-0.5" style={{ 
                            color: item.color,
                    ...
                    <div className="space-y-2.5">
                      {Object.entries(item.metrics).map(([key, value]) => (
                        <div key={key} className="flex justify-between items-center group">
                          <span className="text-[10px] font-medium text-slate-600 uppercase tracking-wider">{key}</span>
                          <span className="text-sm font-bold tracking-tight transition-all duration-200 group-hover:scale-105" style={{ 
                            color: item.color,
                  ...
                  {item.type === 'chart' && item.chartData && (
                    <div className="grid grid-cols-3 gap-4">
                      {Object.entries(item.chartData).map(([key, value]) => (
                        <div key={key} className="text-center">
                          <div className="text-base font-bold tracking-tight mb-0.5 transition-all duration-200 hover:scale-110" style={{ 
                            color: item.color,
                            textShadow: `0 0 20px ${item.color}40`
                          }}>
                            {value}
