    ...
    svg: (
      ...
      >
        <defs>
          ...
          >
            <polygon
              points="6,1 10,3.4 10,7.6 6,10 2,7.6 2,3.4"
              fill="none"
              stroke="#00D9FF"
              strokeWidth="0.2"
              opacity="0.3"
          ...
          >
            ...
            />
            <path
              d="M5 5 L15 5 M5 15 L15 15 M5 0 L5 20 M15 0 L15 20"
              stroke="#0095FF"
              strokeWidth="0.1"
              opacity="0.15"
            />
        ...
        <g opacity="0.7">
          ...
          {[
            ...
            <g key={i}>
              ...
              <circle
                cx={node.x}
                cy={node.y}
                r={5.5 - node.layer * 0.4}
                fill="url(#ai-premium)"
                opacity={0.8 + node.layer * 0.03}
              />
              <circle
                cx={node.x}
                cy={node.y}
                r={3.5 - node.layer * 0.3}
                fill="#00F5FF"
                opacity={0.9 + node.layer * 0.02}
              />
              <circle
                cx={node.x}
                cy={node.y}
                r={2 - node.layer * 0.15}
                fill="#FFFFFF"
                opacity={0.95 - node.layer * 0.03}
              />
              <circle
                cx={node.x}
                cy={node.y}
                r={0.8 - node.layer * 0.05}
                fill="#00D9FF"
                opacity="1"
              />
              <circle
                cx={node.x}
                cy={node.y}
                r={7.5 - node.layer * 0.6}
                fill="none"
                stroke="url(#ai-premium)"
                strokeWidth={0.5 - node.layer * 0.06}
                opacity={0.4 + node.layer * 0.02}
                strokeDasharray={
                  node.type === "output"
                    ? "4 1"
                    : node.type === "input"
          ...
          <path
            d="M20 30 L50 12 L90 8 L130 15 L170 30"
            stroke="url(#ai-grad)"
            strokeWidth="1.5"
            opacity="0.5"
            strokeDasharray="2 1"
          />
          <path
            d="M20 30 L50 30 L90 22 L130 30 L170 30"
            stroke="url(#ai-grad)"
            strokeWidth="2"
            opacity="0.6"
          />
          <path
            d="M20 30 L50 48 L90 52 L130 45 L170 30"
            stroke="url(#ai-grad)"
            strokeWidth="1.2"
            opacity="0.4"
            strokeDasharray="1 2"
          />
          <path
            d="M50 12 L90 22 L130 15"
            stroke="#00D9FF"
            strokeWidth="0.8"
            opacity="0.35"
          />
          <path
            d="M50 30 L90 38 L130 30"
            stroke="#00D9FF"
            strokeWidth="1"
            opacity="0.4"
          />
          <path
            d="M50 48 L90 38 L130 45"
            stroke="#00D9FF"
            strokeWidth="0.8"
            opacity="0.35"
          >
          ...
          <g opacity="0.45">
            ...
            {[
              ...
              <g key={`hex-${i}`}>
                ...
                />
                <polygon
                  points={`${hex.cx},${hex.cy - hex.r * 0.6} ${hex.cx + hex.r * 0.5},${hex.cy - hex.r * 0.3} ${hex.cx + hex.r * 0.5},${hex.cy + hex.r * 0.3} ${hex.cx},${hex.cy + hex.r * 0.6} ${hex.cx - hex.r * 0.5},${hex.cy + hex.r * 0.3} ${hex.cx - hex.r * 0.5},${hex.cy - hex.r * 0.3}`}
                  fill="#00D9FF"
                  opacity="0.15"
                />
              </g>
    ...
    svg: (
      ...
      >
        ...
        <g opacity="0.7">
          ...
          <path
            d="M5 30 C25 15, 35 45, 45 30 S65 12, 85 30 C105 15, 115 45, 125 30 S145 12, 165 30 T195 30"
            stroke="#00FF88"
            strokeWidth="2.5"
            fill="none"
            opacity="0.5"
          ...
          <path
            d="M5 30 C25 45, 35 15, 45 30 S65 48, 85 30 C105 45, 115 15, 125 30 S145 48, 165 30 T195 30"
            stroke="#00FF88"
            strokeWidth="1.8"
            fill="none"
            opacity="0.35"
          ...
          <path
            d="M5 30 L25 26 L35 34 L45 28 L55 32 L65 25 L75 35 L85 29 L95 33 L105 24 L115 36 L125 28 L135 34 L145 26 L155 32 L165 29 L175 33 L185 27 L195 30"
          ...
          {[25, 65, 105, 145, 185].map((x, i) => (
            <g key={i}>
              ...
              <polygon
                points={`${x - 2},12 ${x + 2},12 ${x + 1},15 ${x - 1},15`}
                fill="#00FF88"
                opacity="0.5"
              />
              <polygon
                points={`${x - 2},48 ${x + 2},48 ${x + 1},45 ${x - 1},45`}
                fill="#00FF88"
                opacity="0.5"
              />
            </g>
          ...
          {[35, 85, 125, 165].map((x, i) => (
            <g key={`beam-${i}`}>
              ...
              />
              <polygon
                points={`${x - 3},12 ${x + 3},12 ${x + 1},16 ${x - 1},16`}
                fill="#00FF88"
                opacity="0.4"
              />
              <polygon
                points={`${x - 3},48 ${x + 3},48 ${x + 1},44 ${x - 1},44`}
                fill="#00FF88"
                opacity="0.4"
              />
    ...
    svg: (
      ...
      >
        <defs>
          ...
          >
            <polygon
              points="12,2 20,6 20,14 12,18 4,14 4,6"
              fill="none"
              stroke="#00B4FF"
              strokeWidth="0.2"
              opacity="0.25"
        ...
        <g opacity="0.7">
          ...
          <path
            d="M100 6 L100 54 Q100 60 92 56 L70 44 Q62 41 62 31 L62 16 Q62 8 70 5 L92 0 Q100 -3 100 3 Q100 -3 108 0 L130 5 Q138 8 138 16 L138 31 Q138 41 130 44 L108 56 Q100 60 100 54 Z"
            fill="none"
            stroke="#00B4FF"
            strokeWidth="1.8"
            opacity="0.55"
          ...
          />
          <path
            d="M100 10 L100 50 Q100 55 93 52 L74 42 Q68 40 68 32 L68 20 Q68 14 74 11 L93 4 Q100 2 100 7 Q100 2 107 4 L126 11 Q132 14 132 20 L132 32 Q132 40 126 42 L107 52 Q100 55 100 50 Z"
          ...
          />
          <path
            d="M100 14 L100 46 Q100 50 94 48 L78 40 Q74 38 74 31 L74 22 Q74 17 78 15 L94 8 Q100 6 100 10 Q100 6 106 8 L122 15 Q126 17 126 22 L126 31 Q126 38 122 40 L106 48 Q100 50 100 46 Z"
            fill="#00B4FF"
            opacity="0.18"
            stroke="#00B4FF"
            strokeWidth="0.9"
          ...
          <g opacity="0.25">
            <polygon
              points="100,18 108,22 108,30 100,34 92,30 92,22"
              fill="#00B4FF"
              opacity="0.2"
              stroke="#00B4FF"
              strokeWidth="0.3"
            />
            <polygon
              points="100,22 104,24 104,28 100,30 96,28 96,24"
              fill="#00B4FF"
              opacity="0.25"
              stroke="#00B4FF"
              strokeWidth="0.2"
            />
            <polygon
              points="85,25 93,27 89,35 81,33"
              fill="#00B4FF"
              opacity="0.15"
              stroke="#00B4FF"
              strokeWidth="0.2"
            />
            <polygon
              points="115,25 119,33 111,35 107,27"
              fill="#00B4FF"
              opacity="0.15"
              stroke="#00B4FF"
              strokeWidth="0.2"
          ...
          {[16, 22, 30, 40, 52].map((r, i) => (
            <g key={i}>
              ...
              >
                ...
                <animate
                  attributeName="opacity"
                  values={`${0.35 - i * 0.05};${0.5 - i * 0.05};${0.35 - i * 0.05}`}
                  dur={`${3 + i * 0.5}s`}
                  repeatCount="indefinite"
                />
              </circle>
                  ...
                  {[0, 90, 180, 270].map((angle, j) => (
                    ...
                    >
                      ...
                      >
                        <animate
                          attributeName="r"
                          values={`${1.2 - i * 0.2};${1.8 - i * 0.2};${1.2 - i * 0.2}`}
                          dur={`${2 + j * 0.3}s`}
                          repeatCount="indefinite"
                        />
                      </circle>
                      ...
                      >
                        <animate
                          attributeName="r"
                          values={`${2 - i * 0.3};${3 - i * 0.3};${2 - i * 0.3}`}
                          dur={`${2.5 + j * 0.2}s`}
                          repeatCount="indefinite"
                        />
                      </circle>
          ...
          <g opacity="0.25">
            ...
            {[70, 90, 110, 130].map((x, i) => (
              <polygon
                key={`diamond-${i}`}
                points={`${x},30 ${x + 5},25 ${x},20 ${x - 5},25`}
                fill="none"
                stroke="#00B4FF"
                strokeWidth="0.18"
                opacity={0.2}
      ...
      >
        ...
        <g opacity="0.7">
          ...
          <rect
            ...
            height="38"
            rx="6"
            fill="url(#risk-premium)"
            stroke="url(#risk-premium)"
            strokeWidth="2.5"
            opacity="0.8"
          />
          <rect
          ...
          <path
            d="M86 19 L86 12 Q86 6 100 6 Q114 6 114 12 L114 19"
            stroke="url(#risk-premium)"
            strokeWidth="3.5"
            fill="none"
            opacity="0.8"
          />
          <path
            d="M88 19 L88 14 Q88 10 100 10 Q112 10 112 14 L112 19"
            stroke="#D946EF"
            strokeWidth="2.5"
            fill="none"
            opacity="0.9"
          />
          <path
            d="M90 19 L90 16 Q90 13 100 13 Q110 13 110 16 L110 19"
            stroke="#FFFFFF"
            strokeWidth="1.5"
            fill="none"
            opacity="0.8"
          ...
          <g opacity="0.7">
            <polygon
              points="88,14 94,10 106,10 112,14 106,18 94,18"
              fill="none"
              stroke="#BB00FF"
              strokeWidth="0.6"
              opacity="0.4"
          ...
          <polygon
            points="98,37 102,37 103,45 101,47 99,47 97,45"
            fill="#BB00FF"
            opacity="0.65"
            stroke="#BB00FF"
            strokeWidth="0.3"
          ...
          <g opacity="0.3">
            {[85, 100, 115].map((x, i) => (
              <polygon
                key={`hex-key-${i}`}
                points={`${x},32 ${x + 4},34 ${x + 4},38 ${x},40 ${x - 4},38 ${x - 4},34`}
                fill="none"
                stroke="#BB00FF"
                strokeWidth="0.3"
                opacity="0.25"
          ...
          {[70, 80, 90, 110, 120, 130].map((x, i) => (
            ...
            >
              ...
              <animate
                attributeName="opacity"
                values={`${0.2 + (i % 2) * 0.1};${0.4 + (i % 2) * 0.1};${0.2 + (i % 2) * 0.1}`}
                dur={`${2 + i * 0.1}s`}
                repeatCount="indefinite"
              />
            </line>
          ...
          <g opacity="0.7">
            ...
            <path
              d="M70 12 Q100 8 130 12 Q134 30 130 48 Q100 52 70 48 Q66 30 70 12"
              fill="none"
              stroke="#BB00FF"
              strokeWidth="0.5"
              opacity="0.3"
          ...
          <g opacity="0.2">
            ...
            />
            <polygon
              points="85,25 115,25 110,35 90,35"
              fill="url(#risk-grad)"
              opacity="0.2"
            />
          </g>
        ...
        <div className={`${isMobile ? 'flex flex-col gap-10' : 'grid lg:grid-cols-2 gap-20 items-center'}`}>
          ...
          >
            ...
            >
              ...
              <svg
                className="absolute inset-0 w-full h-full opacity-20 group-hover:opacity-25 transition-opacity duration-500"
                viewBox="0 0 400 400"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <defs>
                  ...
                  >
                    ...
                    />
                    <path
                      d="M0 7.5 L30 7.5 M0 22.5 L30 22.5"
                      stroke="#00D9FF"
                      strokeWidth="0.15"
                      opacity="0.2"
                    />
                    <path
                      d="M7.5 0 L7.5 30 M22.5 0 L22.5 30"
                      stroke="#00D9FF"
                      strokeWidth="0.15"
                      opacity="0.2"
                    />
                ...
                <g transform="translate(200, 200)" opacity="0.4">
                  ...
                  {[0, 60, 120, 180, 240, 300].map((angle, i) => (
                    <g key={`pipeline-${i}`} transform={`rotate(${angle})`}>
                      <path
                        d="M25 0 Q45 -15 65 0 Q85 15 105 0 Q125 -10 140 0"
                        stroke="url(#dash-grad1)"
                        strokeWidth="0.6"
                        opacity="0.35"
                        fill="none"
                        strokeDasharray="2 1"
                      />
                      <path
                        d="M30 0 Q50 -25 70 0 Q90 25 110 0"
                        stroke="#00D9FF"
                        strokeWidth="0.3"
                        opacity="0.2"
                        fill="none"
                  ...
                  <g opacity="0.2">
                    {[0, 72, 144, 216, 288].map((angle, i) => (
                      <g key={`fractal-${i}`} transform={`rotate(${angle})`}>
                        <path
                          d="M20 0 Q30 -10 40 0 Q50 10 60 0 Q70 -15 85 0"
                          stroke="url(#dash-grad1)"
                          strokeWidth="0.4"
                          opacity="0.3"
                          fill="none"
                        />
                        <polygon
                          points="40,0 45,-5 50,0 45,5"
                          fill="#00B4FF"
                          opacity="0.2"
                        />
                        <polygon
                          points="65,0 70,-8 75,0 70,8"
                          fill="#BB00FF"
                          opacity="0.15"
                        />
                      </g>
