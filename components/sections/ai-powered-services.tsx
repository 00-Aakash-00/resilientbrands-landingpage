...
const categories = [
  {
    ...
    svg: (
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g opacity="0.1">
          <rect x="50" y="50" width="80" height="80" fill="#10B981" transform="rotate(45 90 90)" />
          <rect x="270" y="270" width="60" height="60" fill="#10B981" transform="rotate(45 300 300)" />
        </g>
      </svg>
    )
  },
      ...
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(200, 200)">
          ...
          <g transform="translate(8, 8)" opacity="0.7">
            <rect x="-80" y="-60" width="60" height="120" fill="url(#pen-grad-3)" />
            <rect x="-10" y="-80" width="60" height="100" fill="url(#pen-grad-2)" />
            <rect x="60" y="-40" width="60" height="110" fill="url(#pen-grad-3)" />
          </g>
          
          {/* Front blocks */}
          <rect x="-80" y="-60" width="60" height="120" fill="url(#pen-grad-1)" />
          <rect x="-10" y="-80" width="60" height="100" fill="url(#pen-grad-2)" />
          <rect x="60" y="-40" width="60" height="110" fill="url(#pen-grad-1)" />
          
          {/* Connection lines */}
          <path d="M-50 0 L-10 -30 L40 -10 L90 20" stroke="white" strokeWidth="2" fill="none" opacity="0.6" />
          <path d="M-50 30 L20 0 L90 -20" stroke="white" strokeWidth="2" fill="none" opacity="0.4" />
          
          {/* Glowing points */}
          {[{x: -50, y: 0}, {x: 20, y: -30}, {x: 90, y: 20}].map((point, i) => (
            <g key={i}>
              <circle cx={point.x} cy={point.y} r="8" fill="white" opacity="0.9" />
              <circle cx={point.x} cy={point.y} r="12" fill="white" opacity="0.3">
                <animate 
                  attributeName="r" 
                  values="12;20;12" 
                  dur={`${1.5 + i * 0.2}s`} 
  ...
  },
  {
    ...
    svg: (
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(200, 200)">
          {/* Outer glow */}
          <circle cx="0" cy="0" r="140" fill="url(#priv-grad-3)" opacity="0.4" />
          ...
          {/* Lock icon */}
          <g transform="scale(2)">
            <rect x="-15" y="-5" width="30" height="20" rx="3" fill="white" opacity="0.9" />
            <path d="M-8 -5 L-8 -12 Q-8 -20 0 -20 Q8 -20 8 -12 L8 -5" 
        ...
        <g transform="translate(320, 320)">
          <rect x="-30" y="-15" width="60" height="30" rx="15" fill="#1F2937" opacity="0.9" />
          <text x="0" y="5" fontSize="12" fill="white" textAnchor="middle" fontWeight="bold">GDPR</text>
        </g>
