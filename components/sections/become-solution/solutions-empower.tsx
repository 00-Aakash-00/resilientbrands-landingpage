...
const benefits = [
  {
    ...
    description:
      "your solution is championed by providers who have proof of client solution needs.",
  },
  {
      ...
      >
        ...
        >
          ...
          <p
            ...
            } text-neutral-300 text-center max-w-4xl mx-auto leading-relaxed`}
          >
            Resilient Brands bridges the gap between solution creators and
            providers by making MSPs and VARs understand the client offer fit.
          </p>
        </motion.div>
        ...
        >
          <div className="relative">
            ...
            <div
              className={`grid ${
                isMobile ? "grid-cols-1 gap-8" : "grid-cols-3 gap-4"
              }`}
            >
              {/* Solution Creators */}
              <div className="relative">
                <div className="bg-slate-900/80 backdrop-blur-sm rounded-2xl p-6 border border-cyan-500/30">
                  <h3
                    ...
                    } font-semibold text-cyan-400 mb-2`}
                  >
                    Solution Creators
                  </h3>
                  <p
              ...
              <div className="relative">
                <div className="bg-slate-900/80 backdrop-blur-sm rounded-2xl p-6 border border-emerald-500/30">
                  <h3
                    className={`${
                      isSmallMobile ? "text-lg" : "text-xl"
                    } font-semibold text-emerald-400 mb-2`}
                  >
                    MSPs & VARs
                  </h3>
                  <p
