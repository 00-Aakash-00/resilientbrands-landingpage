...
const trends = [
  {
    ...
    description:
      "Eliminate the headache of finding the best tools and services to meet your need with solutions led by the professionals that manage the top performing brands.",
    icon: TrendingUp,
  ...
  },
  {
    ...
    description:
      "Shorten your solution maturity time by collaborating with service providers that manage the problems you solve and advance the market as a team.",
    icon: Zap,
  ...
  },
  {
    ...
    description:
      "You are an expert in your craft and want to serve, join our community and get matched to ideal partners and problems you know you can tackle.",
    icon: Users,
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            <span className="block bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent py-1">
              latest and greatest
            </span>
          </motion.h2>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Resilient brands leverage technology for the competitive edge it can
            provide. Join the top brands that deploy the most advanced tools
              ...
              >
                <div className="relative h-full">
                  ...
                  <div className={`relative h-full ${isMobile ? 'p-5' : 'p-8'} bg-slate-900/30 ${isMobile ? 'rounded-lg' : 'rounded-xl'} border border-slate-800 hover:border-slate-700 transition-all duration-200`}>
                    ...
                    {/* Accent Line */}
                    <div
                      className={`absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r ${trend.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-t-xl`}
                    />
                  </div>
                </div>
              </motion.div>
